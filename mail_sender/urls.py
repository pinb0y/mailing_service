...
from mail_sender.views import MailingListView, MailingCreateView, MailingDeleteView, MailingDetailView, \
    MailingUpdateView, ClientCreateView, ClientUpdateView, ClientDeleteView, ClientListView, MessageCreateView, \
    MessageUpdateView, MessageListView, MessageDeleteView
